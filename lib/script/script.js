...
/**
 * A azart transaction script. Each transaction's inputs and outputs
 * has a script that is evaluated to validate it's spending.
 *
 * See https://en.azart.it/wiki/Script
 *
 * @constructor
...
/**
 * Analogous to azartd's FindAndDelete. Find and delete equivalent chunks,
...
/**
 * Comes from azartd's script interpreter CheckMinimalPush function
...
/**
 * Comes from azartd's script DecodeOP_N function
 * @param {number} opcode
...
/**
 * Comes from azartd's script GetSigOpCount(boolean) function
