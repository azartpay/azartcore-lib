...
/**
 * Retrieve a hexa string that can be used with azartd's CLI interface
 ...
 * * `disableMoreOutputThanInput`: disable checking if the transaction spends more azarts than the sum of the input amounts
 * @return {string}
 */
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'https://azartcore.io/api/lib/transaction#serialization-checks';
 ...
 *
 * Can receive, as output information, the output of azartd's `listunspent` command,
 * and a slightly fancier format recognized by azartcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a azartcore Address object. The
 * same is true for `script`, which can be a string or a azartcore Script.
 *
 ...
 *
 * // From a pay to public key hash output from azartd's listunspent
 ...
 *
 * @see {https://github.com/azart/bips/blob/master/bip-0069.mediawiki}
 * @return {Transaction} this
 */
...
/**
 * Analogous to azartd's IsCoinBase function in transaction.h
 */
