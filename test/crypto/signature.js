...
var JSUtil = azartcore.util.js;
var Interpreter = azartcore.Script.Interpreter;

var sig_canonical = require('../data/azartd/sig_canonical');
var sig_noncanonical = require('../data/azartd/sig_noncanonical');
...
describe('Signature', function() {
  ...
  describe('@isTxDER', function() {
    ...
    describe('azartd fixtures', function() {
