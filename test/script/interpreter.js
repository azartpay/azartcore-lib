...
var BufferWriter = azartcore.encoding.BufferWriter;
var Opcode = azartcore.Opcode;
var _ = require('lodash');

var script_valid = require('../data/azartd/script_valid');
var script_invalid = require('../data/azartd/script_invalid');
var tx_valid = require('../data/azartd/tx_valid');
var tx_invalid = require('../data/azartd/tx_invalid');

//the script string format used in azartd data tests
Script.fromAzartdString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected) {
    var scriptSig = Script.fromAzartdString(vector[0]);
    var scriptPubkey = Script.fromAzartdString(vector[1]);
  ...
  describe('azartd script evaluation fixtures', function() {
  ...
  describe('azartd transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //azartd casts -1 to an unsigned int
            }
            map[txid + ':' + txoutnum] = Script.fromAzartdString(scriptPubKeyStr);
          });
